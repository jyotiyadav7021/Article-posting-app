...
function Navbar () {
  ...
  <div className="flex items-center">
    <div className="flex items-center">
      ...
      <input className="ml-2 outline-none bg-lime-200 font-bold" type="text" name="search" id="search" placeholder="Search..." />
    </div>
    <ul className="flex items-center space-x-6">
      <li className="font-semibold text-gray-700">Home</li>
      <li className="font-semibold text-gray-700"> Your Articles</li>
      <li>
